...
<div class="wrap J_check_wrap">
    ...
    <div class="table_full">
      <table width="100%" cellpadding="2" cellspacing="2">
            ...
            <tr>
              <th width="80">作者 </th>
              <td>
              	<input type="text" style="width:400px;" name="post[post_realauthor]" id="title"  required value="" style="color:" class="input input_hd J_title_color" placeholder="请输入作者" onkeyup="strlen_verify(this, 'title_len', 160)" />
              	<span class="must_red">*</span>
              </td>
            </tr>
            <th width="80">连接分类</th>
            	<td>
            		<select name="post[link_class]" class="normal_select">
						<option value="wait">等待开启</option>
						<option value="reg">立即报名</option>
						<option value="anwser">解题分享</option>
					</select>
				</td>
			</tr>
            <tr>
              <th width="80">url </th>
              <td>
              	<input type="text" style="width:400px;" name="post[post_url]" id="title"   style="color:" placeholder="请输入连接"  />
              </td>
            </tr>
            <tr>
              <th width="80">摘要 </th>
  ...
  <div class="form-actions">
        ...
        <a class="btn" href="/index.php/portal/admin_post">返回</a>
  </div>
 </form>
</div>
